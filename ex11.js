/*
There's a new attraction at this year's Codeville festival. 
The organizers have decided to bring in several inflatable attractions, 
but they have no clue how to much blow them up. 
Each attraction needs to be pumped to a precise volume to achieve maximum festival fun!

The attractions are each made up of a combination of several different shapes: 
cones, spheres and prisms. 
For example, the giant inflatable duck is made up of two spheres (the body and head) and 
a cone (the beak) 🦆.

Each shape has a different calculation for determining volume, 
so we'll need to create a few functions that will help us figure out 
the volume of the various inflatable attractions.
...
sphereVolume() は、与えられた半径から球の体積を計算します。
coneVolume() will calculate the volume of a cone given a radius and a height
coneVolume() は、与えられた半径と高さから円錐の体積を計算します。
...
The fourth function, totalVolume(), will receive an array 
containing the different shapes that make up a single attraction. 
...
The example inputs and outputs below will help you check that each function is correct.
*/
