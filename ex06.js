...
In the array of parking spots, 
spots are written in both lower-case and upper-case. 
...
const whereCanIPark = function (spots, vehicle) {
  ...
  spots.forEach((row, y) =>{
    row.forEach((spot, x) => {
      if((result === false) && (vehicle === 'motorcycle') && (spot === 'S'||spot === 'R'||spot === 'M')){
        result = [x, y]
      } else if((result === false) && (vehicle === 'small') && (spot === 'S'||spot === 'R')){
          result = [x, y]
        } else if ((result === false) && (vehicle === 'regular') && (spot === 'R')){
           result = [x, y]
        } 
